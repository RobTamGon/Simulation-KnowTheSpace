...
from Algorithms.GeneticAlgorithm import Generation_Creation_Parameters, Fitness_Gameplay_Parameters, Crossover_Fusion_Parameters, Crossover_Fusion_Bi_BFS_Fallback_Parameters, Crossover_Fusion_Regeneration_Fallback_Parameters, Crossover_Fusion_Cut_And_Generation_Fallback_Parameters, Crossover_Fusion_Clone_Fallback_Parameters, Mutate_Random_Ending_Parameters, Mutate_Cut_And_Generation_Parameters
...
Filename_Prefix: str = f"Crossover with {"Bi-BFS" if isinstance(Crossover_Parameters.Fallback_Parameters, Crossover_Fusion_Bi_BFS_Fallback_Parameters) else "Cut and Generation"}"
Attempt: int = 1
...
# Genetic Algorithm
Execute__Genetic_Algorithm(Levels, Filename_Prefix, Attempt, Max__Generations, Stop_At__Beating_Level, Generation_Parameters, Fitness_Parameters, Crossover_Parameters, Mutation_Parameters)